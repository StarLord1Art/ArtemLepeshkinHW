...
public interface FilesOperations {
  ...
  ResponseEntity<String> getFileInfo(@Parameter(description = "ID файла") @PathVariable("fileId") String fileId, @Parameter(description = "ID пользователя") @PathVariable("userId") String userId);
  ...
  ResponseEntity<String> getRootDirectories(@Parameter(description = "Название бакета") @PathVariable("bucketName") String bucketName);
}